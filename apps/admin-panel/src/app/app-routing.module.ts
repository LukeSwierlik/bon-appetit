...
import { EmployeeLoginContainerComponent } from './dashboard/containers/employee-login/employee-login-container.component';
...
const routes: Routes = [
    ...
    { path: 'createEmployee-login', pathMatch: 'full', component: EmployeeLoginContainerComponent },
    {
        path: 'user',
